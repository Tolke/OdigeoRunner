    ...
    onResetEvent : function() {
        ...
        me.game.world.addChild(new (me.Renderable.extend ({
            ...
            init : function() {
                ...
                this.scrollertween = new me.Tween(this).to({scrollerpos: -2200 }, 30000).onComplete(this.scrollover.bind(this)).start();
            ...
            draw : function (context) {
               // this.font.draw (context, "1PRESS ENTER TO PLAY", 20, 440);
